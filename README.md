...
* **Frontend**: HTML5, Vanilla JavaScript, CSS (hỗ trợ lấy thời tiết trực tuyến qua Open-Meteo API)
---
## Cách chạy project
### Bước 1: Cài đặt thư viện cần thiết
Mở Terminal tại thư mục dự án và chạy lệnh sau để cài đặt các thư viện:
```bash
